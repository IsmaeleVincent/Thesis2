...
ax.fill_between(data[xg[0,1]:xg[2,0],0]-xmax, data[xg[0,1]:xg[2,0],1],color = (0.2,0.7,0.2), label="1st order excl.\noverlap")
...
ax.fill_between(data[xg[1,1]:,0]-xmax, data[xg[1,1]:,1],color = (0.2,0.2,0.7), label="2nd order excl.\noverlap")
ax.plot(data[:,0]-xmax,data[:,1], "k^", label="Data")
ax.text(0, 50, "1", weight="bold", ha="center", color="w",backgroundcolor="none")
ax.text(10.2, 50, "2", weight="bold", ha="center", color="w",backgroundcolor="none")
ax.text(15,50, "3", weight="bold", ha="center", color="w",backgroundcolor="none")
ax.text(22, 50, "4", weight="bold", ha="center", color="w",backgroundcolor="none")
