...
ax.plot(xplt-xmax, gauss(xplt,*p[0:3]), "-",color=(0.7,0.,0.), alpha=0.8, label="0th order")
ax.plot(xplt-xmax, gauss(xplt,*p[3:6]), "-", color=(0.,0.7,0.), alpha=0.8,label="1st order")
ax.plot(xplt-xmax, gauss(xplt,*p[6:9]), "-", color=(0.,0.,0.7), alpha=0.8, label="2nd order")
