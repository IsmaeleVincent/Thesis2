...
# -*- coding: utf-8 -*-
"""
Created on Mon Dec 19 16:20:53 2022
...
for group in [3]: #0 for Juergen, 1 for Martin, 2 for Christian, 3 for all
    ...
    for k in krange:
        ...
        data_analysis1=sorted_fold_path+foldername[6]+"/Data Analysis/"
        fit_res =  np.loadtxt(data_analysis1+foldername[6]+"_fit_results_"+fit_name+".mpa",skiprows=1)
        p=fit_res[0]
