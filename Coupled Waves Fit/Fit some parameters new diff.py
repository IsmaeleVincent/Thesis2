...
def process_fit(k):
    ...
    if (fitting):
        if k==2 or k>5:
            ...
            P0[5]=0
            P0[6]=0
            B=([5, 0.5, 2.5e-3, 1e-4, 0.0005, -0.0005/rad, -10],[10, 2, 3.6e-3, 1e-3, 0.002, 0.0005/rad, 10])
        if k<2 or (k>2 and k<6):
            P0[0]=8
            P0[1]=1.
            P0[2]=3.4e-3
            ...
            P0[5]=0
            P0[6]=0
            B=([5, 0.5, 2e-3, 1e-4, 0.0001, -0.0005/rad, -10],[10, 2, 3.6e-3, 1e-3, 0.0007, 0.0005/rad, 10])
