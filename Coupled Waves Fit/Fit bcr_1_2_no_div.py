...
# -*- coding: utf-8 -*-
"""
Created on Fri Sep  2 18:19:23 2022
...
fit_res =  np.loadtxt(data_analysis+foldername[0]+'_fit_results_bcr_1_2_no_div.mpa',skiprows=1)
...
with open(sorted_fold_path+'tot_fit_results_bcr_1_2_no_div.mpa', 'w') as f:
      np.savetxt(f,tot_res, header="tilt bcr1 bcr2 mu sigma tau x0 d", fmt="%.2f "+"%.6f "*len(fit_res[0,:]))
with open(sorted_fold_path+'tot_fit_covariances_bcr_1_2_no_div.mpa', 'w') as f:
...
fit_res =  np.loadtxt(sorted_fold_path+'tot_fit_results_bcr_1_2_no_div.mpa',skiprows=1)
fit_cov =  np.loadtxt(sorted_fold_path+'tot_fit_covariances_bcr_1_2_no_div.mpa',skiprows=1)
