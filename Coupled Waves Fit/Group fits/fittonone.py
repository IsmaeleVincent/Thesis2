...
n_shared=3
p_name=["$(b_c \\rho)_1$","$(b_c \\rho)_2$", "$\phi$", "$\mu$", "$\sigma$","$\\tau$", "$x_0$","$\zeta_0$"]
p_units=[" $1/\mu m^2$"," $1/\mu m^2$", "$ \pi$"," nm", " nm", "", " deg", "  deg"]
...
def diff_eff_calc(k,bcr1, bcr2, phi, mu1, sigma, tau, x00, zeta0):
...
fit_name="bcr_1_2_3_phi_1_2"
n_shared=5
p_name=["$(b_c \\rho)_1$","$(b_c \\rho)_2$","$(b_c \\rho)_3$", "$\phi$", "$\phi_1$", "$\mu$", "$\sigma$","$\\tau$", "$x_0$","$\zeta_0$"]
p_units=[" $1/\mu m^2$"," $1/\mu m^2$"," $1/\mu m^2$", "$ \pi$", "$ \pi$"," nm", " nm", "", " deg", "  deg"]
...
def diff_eff_calc(k,bcr1, bcr2, bcr3, phi, phi2, mu1, sigma, tau, x00, zeta0):
    data_analysis = sorted_fold_path+foldername[k]+"/Data Analysis/"
    diff_eff =  np.loadtxt(data_analysis+foldername[k]+"_diff_eff_new.mpa",skiprows=1)
    x=diff_eff[:,0]+x00
    phi=phi*pi
...
B0i=[5, 0, 0, 0, 0, 1.4e-3, 2e-5, 0.5, -0.0005/rad, -2]
B0f=[13, 7, 5, 2, 2, 4e-3, 0.65e-3, 10, 0.0005/rad, 2]
Bi_groups=[B0i, B0i, B0i, B0i]
Bf_groups=[B0f, B0f, B0f, B0f]
...
fit_name="bcr_1_2_phi_d_no_zeta0"
n_shared=4
p_name=["$(b_c \\rho)_1$","$(b_c \\rho)_2$", "$\phi$","d", "$\mu$", "$\sigma$","$\\tau$", "$x_0$"]
p_units=[" $1/\mu m^2$"," $1/\mu m^2$", "$ \pi$", "  $\mu m$"," nm", " nm", "", " deg"]
zeta0=0
pi=np.pi
rad=pi/180
...
def diff_eff_calc(k,bcr1, bcr2, phi, d, mu1, sigma, tau, x00):
    data_analysis = sorted_fold_path+foldername[k]+"/Data Analysis/"
    diff_eff =  np.loadtxt(data_analysis+foldername[k]+"_diff_eff_new.mpa",skiprows=1)
    x=diff_eff[:,0]+x00
    phi=phi*pi
