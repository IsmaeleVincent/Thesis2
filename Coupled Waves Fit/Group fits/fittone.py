...
for group in [2]: #0 for Juergen, 1 for Martin, 2 for Christian, 3 for all 
    ...
    def process_fit(k):
        ...
        if (fitting):
            ...
            P0[8]=1
            P0[9]=0
            Bi_groups=[[5, 0, 0, 2.0e-3, 2e-5, 3, -0.0005/rad, -2, 0, 0],
                      [5, 0, 0, 2.0e-3, 2e-5, 3, -0.0005/rad, -2, 0, 0],
                      [5, 0, 0, 2.0e-3, 2e-5, 3, -0.0005/rad, -2, 0, 0],
                      [5, 0, 0, 2.0e-3, 2e-5, 3, -0.0005/rad, -2, 0, 0]]
            Bf_groups=[[13, 5, 5, 4e-3, 1e-3, 10, 0.0005/rad, 2,2,2],
                      [13, 5, 5, 4e-3, 1e-3, 10, 0.0005/rad, 2,2,2],
                      [13, 5, 5, 4e-3, 1e-3, 10, 0.0005/rad, 2,2,2],
                      [13, 5, 5, 4e-3, 1e-3, 10, 0.0005/rad, 2,2,2]]
    ...
    def process_fit(k):
        ...
        if (fitting):
            ...
            P0[6]=0
            P0[7]=1
            Bi_groups=[[5, 0, 2.0e-3, 2e-5, 3, -0.0005/rad, -2, 0],
                      [5, 0, 2.0e-3, 2e-5, 3, -0.0005/rad, -2, 0],
                      [5, 0, 2.0e-3, 2e-5, 3, -0.0005/rad, -2, 0],
                      [5, 0, 2.0e-3, 2e-5, 3, -0.0005/rad, -2, 0]]
            Bf_groups=[[13, 5, 4e-3, 1e-3, 10, 0.0005/rad, 2, 2],
                      [13, 5, 4e-3, 1e-3, 10, 0.0005/rad, 2, 2],
                      [13, 5, 4e-3, 1e-3, 10, 0.0005/rad, 2, 2],
                      [13, 5, 4e-3, 1e-3, 10, 0.0005/rad, 2, 2]]
