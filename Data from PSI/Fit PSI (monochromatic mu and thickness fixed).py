...
P0= np.zeros(3) # [*fit_res[0,:-1],0,0]  # fit_res[0] #  [8, 2,0, 2.01e-3, pi,0, 75, 1000, 0.0004] #    [5,0,2.6e-3] # 
P0[0]=5
P0[1]=3
P0[2]=0
# P0[3]=42
# P0[9]=0.0
if (fitting):
    B=([0, 0, -0.001/rad],[15, 15, 0.001/rad])
